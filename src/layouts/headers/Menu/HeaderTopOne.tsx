            ...
            <div className="header-top-wrp">
               <ul className="info">
                  <li><svg width="15" height="12" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                     ...
                     <Link href="mailto:info@g-energy.global" className="ms-1">info@g-energy.global</Link>
                  </li>
                  <li className="ms-4"><svg width="16" height="15" viewBox="0 0 16 15" fill="none"
                     ...
                     <Link href="https://www.g-energy.global" target="_blank" rel="noreferrer" className="ms-1">www.g-energy.global</Link>
                  </li>
               </ul>
