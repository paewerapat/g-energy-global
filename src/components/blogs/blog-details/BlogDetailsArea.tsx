...
import blog_thumb3 from "@/assets/images/blog/blog-single-sm2.jpg"
...
const blog_content: ContentDataType = {
   title_1: "Tackling the Changes of Retail Industry",
   ...
   desc_5: "Pellentesque sollicitudin congue dolor non aliquam. Morbi volutpat, nisi vel ultricies urnacondimentum, sapien neque lobortis tortor, quis efficitur mi ipsum eu metus. Praesent eleifend orci sit amet est vehicula.",
   desc_6: "Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore of magna aliqua. Ut enim ad minim veniam, made of owl the quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea dolor commodo consequat. Duis aute irure and dolor in reprehenderit.",
}

const { title_1, desc_1, desc_2, desc_3, desc_4, desc_5, desc_6, } = blog_content;
                     ...
                     <div className="blog__content p-0">
                        <ul className="pb-3 pt-30 bor-bottom d-flex gap-4 flex-wrap align-items-center">
                           <li>
                              ...
                              <a href="blog-single.html"><span className="primary-hover transition">By
                                 Admin</span></a>
                           </li>
                           <li>
                              <svg className="me-1" width="20" height="20" viewBox="0 0 20 20" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                 <path
                           ...
                           <li>
                              ...
                              <a href="blog-single.html"><span
                                 className="primary-hover transition">Technology</span></a>
                           </li>
                        </ul>
                        <h3 className="blog-single__title mt-20">{title_1}</h3>
                        <p className="mb-20 mt-20">{desc_1}</p>
                        <p className="mb-20">{desc_2}</p>
                        <p className="mb-20">{desc_3}</p>
                        <div className="row">
                           <div className="col-6">
                              <div className="image">
                                 <Image src={blog_thumb2} alt="image" />
                              </div>
                           </div>
                           <div className="col-6">
                              <div className="image">
                                 <Image src={blog_thumb3} alt="image" />
                              </div>
                           </div>
                        </div>
                        ...
                        <div className="tags-share mt-40">
                           ...
                           <div className="share">
                              ...
                              <Link className="active" href="#"><i className="fa-brands fa-twitter"></i></Link>
